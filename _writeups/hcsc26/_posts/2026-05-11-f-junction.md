...
![Challenge formulas](/writeups/hcsc26/images/image9.png)

The junction ELF just calls the junk functions in the order given by formula A. This is meant to serve as a tutorial as stated by the description. I opened up the lib with Binary Ninja and analyzed the file for a bit. All junc functions manipulate a buffer and a cursor as seen here:

![Function analysis](/writeups/hcsc26/images/image10.png)
...
![Better output](/writeups/hcsc26/images/image13.png)
...
![Anti-debugging code](/writeups/hcsc26/images/image16.png)
...
![Process name check](/writeups/hcsc26/images/image17.png)
...
![Solution output](/writeups/hcsc26/images/image18.png)
